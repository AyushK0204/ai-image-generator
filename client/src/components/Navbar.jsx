        ...
        {user ? (
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-br from-gray-400 via-white to-gray-400 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-300"
            >
